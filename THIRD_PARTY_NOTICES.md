...
DrvMatch 0.8.0 directly adds or relies on these principal Rust libraries for Microsoft source discovery:
...
- `cab` 0.6 — CAB archive decoding used for Dell and HP OEM catalog metadata.
